...
public class Cubo extends MIDlet implements CommandListener {
    ...
    class Perspectiva extends Canvas {
        ...
        public void paint(Graphics g) {
            ...
            line(g, 3, 4);
            line(g, 4, 5);
            line(g, 5, 3); // superior horizontal edge
            //line(g, 6, 7);
            line(g, 0, 3);
            line(g, 1, 4);
            line(g, 2, 5);
    ...
    class Obj {	// Data from the 3D objects 
        ...
        Point3D[] w;	// universal coordinates
        ...
        w[0] = new Point3D(2, -2, -2); // the base 
	w[1] = new Point3D(2, 2, -2); 
	w[2] = new Point3D(0, 2, -2); 
	//w[3] = new Point3D(-1, -1, -1); 
	w[3] = new Point3D(2, -2, 2); 
	w[4] = new Point3D(2, 2, 2); 
